...
namespace LEGOModelImporter
{
    ...
    public class ToolsSettings
    {
        ...
        #region Pref keys
        static readonly string stickySnapDistancePrefsKey = "com.lego.modelimporter.stickySnapDistance";
        static readonly string disablePrefabAutoSavePrefsKey = "com.lego.modelimporter.disablePrefabAutoSave";
        static readonly string maxTriesPerBrickPrefsKey = "com.lego.modelimporter.maxTriesPerBrick";
        static readonly string selectConnectedPrefsKey = "com.lego.modelimporter.selectConnected";
        static readonly string brickBuildingPrefsKey = "com.lego.modelimporter.editorBrickBuilding";
        static readonly string rotateGizmoOnPrefsKey = "com.lego.modelimporter.rotateGizmoOn";
        static readonly string showToolsPrefsKey = "com.lego.modelimporter.showBrickBuildingTools";
#if !PUBLIC
        static readonly string autoUpdateHierarchyPrefsKey = "com.lego.modelimporter.autoUpdateHierarchy";
#endif
        #endregion
