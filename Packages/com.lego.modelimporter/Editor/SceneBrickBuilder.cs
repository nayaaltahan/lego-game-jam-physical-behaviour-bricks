...
namespace LEGOModelImporter
{
    ...
    public class SceneBrickBuilder
    {
        ...
        {
            rotationArrowUpNormal = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Rotate Forwards Normal@2x.png");
            rotationArrowRightNormal = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Rotate Right Normal@2x.png");
            rotationArrowDownNormal = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Rotate Backwards Normal@2x.png");
            rotationArrowLeftNormal = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Rotate Left Normal@2x.png");

            rotationArrowUpActive = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Rotate Forwards Active@2x.png");
            rotationArrowRightActive = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Rotate Right Active@2x.png");
            rotationArrowDownActive = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Rotate Backwards Active@2x.png");
            rotationArrowLeftActive = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Rotate Left Active@2x.png");

            rotationArrowUpHover = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Rotate Forwards Hover@2x.png");
            rotationArrowRightHover = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Rotate Right Hover@2x.png");
            rotationArrowDownHover = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Rotate Backwards Hover@2x.png");
            rotationArrowLeftHover = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Rotate Left Hover@2x.png");
        }
        ...
        {            
            ...
            if(BrickBuildingUtility.Colliding(selectedBricks, selectionBounds, focusBrick.gameObject.scene.GetPhysicsScene(), out _))
            {
                foreach (var brick in selectedBricks)
                {
        ...
        private static void PlaceBrick()
        {
            ...
            if (!BrickBuildingUtility.Colliding(selectedBricks, selectionBounds, focusBrick.gameObject.scene.GetPhysicsScene(), out _, true))
            {
                foreach (var brick in selectedBricks)
                {
                    brick.UpdateColliding(false);
        ...
        {
            var mouseDelta = Vector2.Distance(newMousePosition, mousePosition);
...
#region event handling
        ...
        private static void ComputeNewConnection(Camera camera, Ray ray)
        {
            ...
            var isColliding = BrickBuildingUtility.Colliding(selectedBricks, selectionBounds, focusBrick.gameObject.scene.GetPhysicsScene(), out _, true);
                            ...
                            if(field is PlanarField planar)
                            {
                                foreach(var connection in planar.connections)
                                {
                                    if (connection != null)
                                    {
                                        ...
                                        planar.OnConnectionChanged(connection);
                                    }
                                }
                            }
        ...
        {            
            ...
            if (duplicateQueued)
            {
                ...
                if(focusBrick != null && IsOverSceneView())
                {
                    StartMovingBricks();
