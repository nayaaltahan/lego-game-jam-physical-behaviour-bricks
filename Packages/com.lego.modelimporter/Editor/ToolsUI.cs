...
namespace LEGOModelImporter
{
    ...
    public class ToolsUI
    {
        ...
        static void Init()
        {
            if (!initialised)
            {
                brickBuildingOnImage = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Brick Building On@2x.png");
                brickBuildingOffImage = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Brick Building Off@2x.png");
                selectConnectedOnImage = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Select Connected On@2x.png");
                selectConnectedOffImage = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.lego.modelimporter/Textures/Select Connected Off@2x.png");
