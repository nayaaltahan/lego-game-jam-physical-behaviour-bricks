...
namespace LEGOModelImporter
{
    ...
    public class MeshTool
    {
        ...
        public void GenerateKnobNormalMapUVs(float size)
        {
            Matrix4x4 uvMatrix = Matrix4x4.TRS(Vector3.one * 0.5f, Quaternion.Euler(0, 90, 90), new Vector3(1.0f / size, 0.0f, -1.0f / size));
